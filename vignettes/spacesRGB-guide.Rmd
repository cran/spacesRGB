...
Signal RGB is also called _non-linear RGB_ and _encoded RGB_.

<!-- Sometimes we call "_signal RGB_"  _"display signal RGB"_ for emphasis. -->


These packages are suggested:
